...
$(document).ready(function () {
  var swiper = new Swiper(".object-slider-1", {
    loop: true,
    centeredSlides: true,
  ...
  var swiper2 = new Swiper(".object-slider-2", {
    loop: true,
    centeredSlides: true,
    watchSlidesVisibility: true,
    slidesPerView: 1.5,
  ...
  var swiper3 = new Swiper(".object-slider-3", {
    loop: true,
    centeredSlides: true,
    watchSlidesVisibility: true,
    slidesPerView: 1.5,
  ...
  var swiper4 = new Swiper(".object-slider-4", {
    loop: true,
    centeredSlides: true,
    watchSlidesVisibility: true,
    slidesPerView: 1.5,
  ...
  var swiper5 = new Swiper(".object-slider-5", {
    loop: true,
    centeredSlides: true,
    watchSlidesVisibility: true,
    slidesPerView: 1.5,
...
$(document).ready(function () {
  ...
  if (navigator.userAgent.indexOf("MSIE") != -1 || navigator.userAgent.indexOf("rv:11.0") != -1) browser = "msie";else if (navigator.userAgent.indexOf("Edge") != -1) browser = "microsoft-edge";else if (navigator.userAgent.indexOf("Firefox") != -1) browser = "firefox";else if (navigator.userAgent.indexOf("Opera") != -1) browser = "opera";else if (navigator.userAgent.indexOf("Chrome") != -1) browser = "chrome";else if (navigator.userAgent.indexOf("Safari") != -1) browser = "safari";
